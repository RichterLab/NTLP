...
! Long (1974) collection efficiencies (as in Bott 1998)
  ...
  ! Binary search: returns index of first element of arr strictly greater
  ! than val.  arr must be sorted ascending.  Equivalent to
  ! minloc(arr,1,mask=(arr.gt.val)) but O(log n) instead of O(n).
